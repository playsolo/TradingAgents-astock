...
def create_news_analyst(llm):
    def news_analyst_node(state):
        ...
        system_message = (
            ...
            "\n- **利好兑现 / 定价状态**：对重要利好必须判定 未定价 / 部分定价 / 已兑现。"
            "依据包括：传闻 vs 已公告落地、事件前涨幅是否已透支、公告后冲高回落/放量滞涨、情绪是否极端一致乐观。"
            "已兑现不等于利空，但应明确提示「卖预期」风险，避免把落地利好直接写成追高买入理由。"
            "\n\n请使用以下工具："
            ...
            "\n\n撰写全面的新闻分析报告，区分利好/利空/中性消息，评估影响程度、持续时间和定价状态。报告末尾附 Markdown 表格汇总关键新闻事件及其影响评级与定价状态。"
